...
////////////////////////////////////////////////////////////////////
        ...
        public const string LIBNAME = @"\\wdciis03\gedoc_scan$\DLL\NSOCR.dll"; //IMPORTANT: CORRECT PATH TO X86 NSOCR.DLL
        //for x64
...
////////
        ...
        [DllImport(LIBNAME)]
        public static extern int Img_LoadBmpData(int ImgObj, IntPtr Bytes, int Width, int Height, int Flags);
