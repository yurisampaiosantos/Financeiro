...
{
    public partial class frmInfoR2099 : Form
    {
        private R2099DAL objEvento;
        public frmInfoR2099()
        {
            InitializeComponent();
        }

        private void frmInfoR2099_Load(object sender, EventArgs e)
        {
            objEvento = new R2099DAL();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (objEvento.verificaCompetencia(idReg))
                {
                    Assinatura.assinarEnviarXML(idReg, objEvento.getXMLEvt(idReg), "evtFechaEvPer");
                }
                else
                {
                    MessageBox.Show("É necessario o preenchimento da 1ª competêmncia");
                }
                AtualizaGrid();
        ...
        {
            frmDadosR2099 f = new frmDadosR2099();
            f.ShowDialog();
            AtualizaGrid();
           // dgvEventos.DataSource = objEvento.getData();
        }
